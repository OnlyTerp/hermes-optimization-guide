...
- **Platforms.** The gateway ships ~30+ adapters now (a2a, webhooks, teams-meetings, wecom, qqbot, yuanbao, bluebubbles, homeassistant, … on top of the classics). Treat the *live* `/platforms` slash output as the count — "22+"/"25+" from older guide waves is stale.
